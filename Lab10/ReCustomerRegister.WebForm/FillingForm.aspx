<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FillingForm.aspx.cs" Inherits="ReCustomerRegister.WebForm.FillingForm" %>
...
<body>
    <form id="FillingForm" runat="server">
        <div>
            ...
            <tr>
                <td class="auto-style3" colspan="2" style="background-color: #FFFFFF; color: #000000; font-weight: bold">Customer Register</td>
            </tr>
            <tr>
                <td class="auto-style2" colspan="2" style="color: #FFFFFF; background-color: #0000FF; font-weight: bold;">Authentication credentials</td>
            </tr>
            <tr>
